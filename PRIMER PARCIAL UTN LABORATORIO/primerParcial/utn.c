...
/**
 * \brief comprueba que el numero ingresado este dentro de los parametros establecidos. Devuelve 0 si es correcto y -1 o 1 si se paso de los limites.
 * \param mensaje Es el mensaje a ser mostrado
 * \return Resultado de la operacion (exitosa o no). Carga el valor en el espacio de memoria establecido.
 *
 */
